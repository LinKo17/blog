<div >
    <div class="container">
        ...
        <div class="report_bar_style text-center">
            ...
            <span class="report_number badge bg-primary">5</span>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-1 dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    data-bs-target="#exampleModal"><span class="text-danger">Reject</span></a>
                ...
                <div class="modal-content">
                    ...
                    <form name="editForm" id="myEditForm">
                        <div class="modal-body">
                            ...
                            <div class="my-2">
                                <label for="report_type"><span class="text-danger">Choice Reject</span></label>

                                <select name="report_type" id="report_type" class="form-control">

                                    <option value="1">
                                        <span class="text-danger">Reject One</span>
                                    </option>

                                    <option value="2">
                                        <span class="text-danger">Reject Two</span>
                                    </option>

                                    <option value="3">
                                        <span class="text-danger">Reject Three</span>
                                    </option>
